...
# Training and test scores similar; likely underfitting data; try setting C=100
...
# look at the coefficients learned byt the models  with three different settings of the regularization parameter c
